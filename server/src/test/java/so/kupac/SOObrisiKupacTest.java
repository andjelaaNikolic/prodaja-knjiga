...
class SOObrisiKupacTest {

    private SOObrisiKupac so;

    @BeforeEach
    void setUp() {
        so = new SOObrisiKupac();
    }
    ...
    private SOObrisiKupac napraviSOSaMockom(
        ...
        SOObrisiKupac soMock = new SOObrisiKupac();
    ...
    @Test
    void testIzvrsiKupacSeNeKoristiBrisanjeUspeh() throws Exception {
        ...
        try (MockedStatic<DBKonekcija> mockedStatic = mockStatic(DBKonekcija.class)) {
            ...
            SOObrisiKupac soMock = napraviSOSaMockom(
                    mockBroker,
                    mockConnection,
                    mockedStatic);
    ...
    @Test
    void testIzvrsiKupacSeKoristiBrisanjeNeuspeh() throws Exception {
